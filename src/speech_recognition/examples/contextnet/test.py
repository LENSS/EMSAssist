...
"""
The main function to evaluate the WER and CER of ContextNet on our EMS audio dataset. It uses ContextNet to 
...
Input:  1) output: path of the intermediate transcription result output text file
        2) saved: the contextnet h5 model used to transcribe the EMS audio files
